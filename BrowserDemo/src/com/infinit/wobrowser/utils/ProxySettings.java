...
/**
  * ���棺����취�ͽ�����ο�stackoverflow˵�� 
  * http://stackoverflow.com/questions/4488338/webview-android-proxy
  * 
  * I have adapted the three solutions presented here (and modified one where it failed) to produce a single, 
  * simple setProxy method that works for all versions of Android. 
  * I've tested it from 10 to 18, and it works for all tested environments.
  *
  * UPDATED 2014-04-04 I finally worked in the solution from a comment below, 
  * courtesy of nubela and xjy2061. Now this works for all current Android versions, including KitKat 4.4. 
  * If you implement your own Application subclass, supply the name of the class as the optional fourth parameter.
  *
  * UPDATED 2015-01-15 The part labeled optional in the KitKat method throws an exception on Lollipop 
  * because an auxiliary class is missing, but without that it works on both KitKat and Lollipop, 
  * since the WebView is based on Chromium in both cases.
  */
