...
public class FileDownLoadUtils {
	 ...
	 * @return
	 */
	public static String getMimeExtendsName(String mimeType, String mimeExtends) {
		String type=null;
		for (int i = 0; i < MIME_MapTable.length; i++) {
			if (MIME_MapTable[i][1].equals(mimeType)) {
				if (mimeExtends.contains(MIME_MapTable[i][0])) {
